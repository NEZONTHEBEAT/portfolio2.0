...
![BCA](https://img.shields.io/badge/BCA-Student-orange?style=for-the-badge)
...
I enjoy building modern, responsive, user-friendly web applications and digital experiences.
...
`FastAPI` `Python` `SQLite` `HTML` `Tailwind CSS` `TypeScript`
...
`HTML` `CSS` `JavaScript` `Flask` `TiDB Cloud` `Razorpay` `Twilio`
